...
namespace ImageProcess2
{
    ...
    {
        public int TopLeftWeight = 0, TopMiddleWeight = 0, TopRightWeight = 0;
        public int MiddleLeftWeight = 0, CentralPixelWeight = 1, MiddleRightWeight = 0;
        public int BottomLeftWeight = 0, BottomMiddleWeight = 0, BottomRightWeight = 0;
        public int NormalizationFactor = 1;
        public int OffsetValue = 0;

        public void SetAllWeights(int weightValue)
        {
            TopLeftWeight = TopMiddleWeight = TopRightWeight = MiddleLeftWeight = CentralPixelWeight = MiddleRightWeight = BottomLeftWeight = BottomMiddleWeight = BottomRightWeight = weightValue;
        }
    }

    public struct FloatingPointCoordinate
    {
    ...
    {
        public const short EdgeDetectionKirsh = 1;
        public const short EdgeDetectionPrewitt = 2;
        public const short EdgeDetectionSobel = 3;
        ...
        public static void Threshold(ref Bitmap image, int threshold)
        {
            ...
            unsafe
            {
                int padding = data.Stride - image.Width * 3;
